...
class Beat(BaseModel):
    ...
    def comment_feed_html(self):
        """HTML used for comment beats in atom feeds: a link to the comment
        and the thread it was posted on, followed by optional commentary
        and note."""
        parts = [
            '<p><a href="{}">My comment</a> on <a href="{}">{}</a> on {}.</p>'.format(
                escape(self.url),
